<template>
  <div class="container">
    ...
    <div id="q-app" style="min-height: 50px">
      <div class="q-pa-md">
        <q-btn-dropdown
          color="blue-9"
          label="GENERO"
        ...
        >
          <q-list>
            <q-item clickable v-close-popup @click="onItemClick">
              <q-item-section>
                <q-item-label>Femenino</q-item-label>
              </q-item-section>
            </q-item>
    ...
    <label for="nroContacto"><b>N°Contacto</b></label>
    <input
      type="text"
...
export default {
  ...
  methods: {
    signUp() {
      ...
      var url = "http://localhost:5083/swagger/index.html/";
